...
final class PreservingScheduledExecutorService extends DecoratingScheduledExecutorService {

    private final ScheduledExecutorService executor;
    private final Tracer tracer;

    PreservingScheduledExecutorService(final ScheduledExecutorService executor, final Tracer tracer) {
